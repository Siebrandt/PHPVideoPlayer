...
<body>
	<header>
            ...
            <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-md-7 py-4">
                            ...
                            <p class="text-muted">Dies ist ein Projekt für die GIBS für das Modul M152 im Informatik</p>
                        </div>
        ...
        <div class="navbar navbar-dark bg-dark shadow-sm">
            ...
            <a href="../Controller/index.php" class="navbar-brand d-flex align-items-center">
            	<strong>Videoplayer Projekt</strong>
            </a>
